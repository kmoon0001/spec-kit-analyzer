...
async def start_cleanup_services(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to start cleanup services: {e}")
...
async def stop_cleanup_services(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to stop cleanup services: {e}")
