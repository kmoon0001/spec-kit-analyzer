...
async def get_current_level():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to get current strictness level"
        ) from e
    ...
    try:
        ...
        performance_metrics = {
            ...
            "processing_time_avg": float(
                level_config.processing_time_target.split("-")[0]
            ),
            "success_rate": 0.95,
        ...
        raise HTTPException(
            status_code=500, detail="Failed to set strictness level"
        ) from e
...
async def get_recommended_level():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to get recommendation"
        ) from e
...
def supports_feature(feature: str) -> bool:
    ...
    feature_support = {
        ...
        "comprehensive_fact_checking": config.fact_checking
        in ["comprehensive", "maximum"],
