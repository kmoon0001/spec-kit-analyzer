...
from .routers import auth, analysis, dashboard # Import the new router
...
app.include_router(dashboard.router, prefix="/dashboard", tags=["dashboard"]) # Add the new router
