...
class PerformanceMetrics:
    ...
    memory_usage: Optional[MemoryMetrics] = None
    cache_performance: Optional[CacheMetrics] = None
    resource_utilization: Optional[ResourceMetrics] = None
    throughput: Optional[ThroughputMetrics] = None
    error_rates: Optional[ErrorRateMetrics] = None
...
class BaselineMetricsCollector:
    ...
    def get_baseline_summary(self) -> Optional[PerformanceMetrics]:
