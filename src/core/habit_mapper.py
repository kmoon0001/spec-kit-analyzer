...
def get_habit_for_finding(finding: Dict) -> Dict:
    ...
    elif 'goal' in issue_title or 'plan of care' in issue_title:
        return {
    ...
    elif 'skilled' in issue_title or 'medical necessity' in issue_title or 'justify' in issue_title:
        return {
    ...
    elif 'collaboration' in issue_title or 'interdisciplinary' in issue_title or 'billing' in issue_title:
        return {
