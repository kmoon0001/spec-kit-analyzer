...
def create_bm25_index():
    ...
    with open("medicare_benefit_policy_manual_chapter_8.txt", "r", encoding="utf-8") as f:
        text = f.read()
    ...
    if len(corpus) <= 1:
        print("Error: The document was not split into multiple sections. The index will not be effective.")
