...
class PDFExportService:
    ...
    def export_compliance_report(self, 
                               ...
                               output_path: str,
                               include_branding: bool = True) -> bool:
        """
    ...
    def _add_header(self, story: List, report_data: Dict[str, Any], include_branding: bool):
        ...
        doc_info = [
            ...
            ['Analysis Date:', report_data.get('analysis_date', datetime.now().strftime('%Y-%m-%d %H:%M'))],
    ...
    def _add_detailed_findings(self, story: List, report_data: Dict[str, Any]):
        ...
        for finding in findings:
            ...
            recommendation = finding.get('personalized_tip', 'No recommendation')[:100] + '...'
    ...
    def _add_footer_info(self, story: List, report_data: Dict[str, Any]):
        ...
        # Generation info
        gen_info = f"Report generated on {datetime.now().strftime('%Y-%m-%d at %H:%M:%S')}"
