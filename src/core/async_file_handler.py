...
class AsyncFileHandler:
    ...
    async def read_document_async(self, file_path: Path) -> Optional[str]:
        """
    ...
    def _read_document_sync(self, file_path: Path) -> Optional[str]:
    ...
    async def read_config_async(self, config_path: Path) -> Optional[Dict[str, Any]]:
        """
    ...
    def _read_config_sync(self, config_path: Path) -> Optional[Dict[str, Any]]:
    ...
    async def batch_read_documents(self, file_paths: list[Path], 
                                 progress_callback=None) -> Dict[Path, Optional[str]]:
        """
