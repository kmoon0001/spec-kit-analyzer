...
class AnalysisErrorHandler:
    ...
    def categorize_and_handle_error(
        self, error_message: str, context: dict[str, object] | None = None
    ) -> AnalysisError:
    ...
    def _create_error_response(
        self, category: ErrorCategory, original_error: str, context: dict[str, object] | None = None
    ) -> AnalysisError:
