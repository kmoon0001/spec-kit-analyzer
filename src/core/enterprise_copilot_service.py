...
class EnterpriseCopilotService:
    ...
    async def process_query(self,
        ...
        try:
            ...
            logger.info("Processing copilot query: %s...", query[:100])
    ...
    async def get_contextual_suggestions(self,
        ...
        """
        try:
            logger.info("Generating contextual suggestions for context: %s", context)
            ...
            logger.exception("Contextual suggestions generation failed: %s", e)
            return {
                "suggestions": [],
                "tips": [],
                "best_practices": [],
    ...
    async def process_feedback(self, feedback_data: dict[str, Any], user_id: int) -> dict[str, Any]:
        ...
        try:
            ...
            logger.info("Processed feedback from user %s: {feedback_id}", user_id)
