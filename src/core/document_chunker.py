...
class DocumentChunker:
    ...
    def _get_overlap_sentences(self, sentences: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def chunk_document_by_sections(self, text: str, section_headers: Optional[List[str]] = None) -> List[Dict[str, Any]]:
        """
    ...
    def _split_by_sections(self, text: str, headers: List[str]) -> List[Dict[str, Any]]:
        ...
        header_pattern = r'^\s*(' + '|'.join(re.escape(h) for h in headers) + r')\s*:?\s*'
