...
class ExpansionResult:
    ...
    def get_expanded_query(self, max_terms: Optional[int] = None) -> str:
...
class QueryExpander:
    ...
    def __init__(self, 
                 medical_vocab: Optional[MedicalVocabulary] = None,
    ...
    def expand_query(self, 
                    ...
                    context_entities: Optional[List[str]] = None) -> ExpansionResult:
