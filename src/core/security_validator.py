...
class SecurityValidator:
    ...
    def validate_filename(filename: str) -> tuple[bool, Optional[str]]:
        ...
        if file_ext not in SecurityValidator.ALLOWED_FILE_EXTENSIONS:
            return False, f"File type not allowed. Allowed types: {', '.join(SecurityValidator.ALLOWED_FILE_EXTENSIONS)}"
    ...
    def validate_analysis_mode(mode: str) -> tuple[bool, Optional[str]]:
        ...
        if mode.lower() not in SecurityValidator.ALLOWED_ANALYSIS_MODES:
            return False, f"Invalid analysis mode. Allowed values: {', '.join(SecurityValidator.ALLOWED_ANALYSIS_MODES)}"
