    ...
    def _initialize_checklist_items(self) -> List[ChecklistItem]:
        ...
        return [
            ...
            ChecklistItem(
                ...
                keywords=[
                    "frequency", "per week", "times per week", "x/week",
                    "sessions per week", "weekly", "daily", "2x/week", "3x/week"
                ],
                recommendation=(
            ...
            ChecklistItem(
                ...
                keywords=[
                    "goal", "progress", "updated goal", "goal status",
                    "short-term goal", "long-term goal", "objective met",
                    "goal achieved", "progress toward", "STG", "LTG"
                ],
                recommendation=(
            ...
            ChecklistItem(
                ...
                keywords=[
                    "medical necessity", "medically necessary", "skilled care",
                    "clinical rationale", "justification", "requires therapy",
                    "therapeutic intervention", "skilled intervention"
                ],
                recommendation=(
            ...
            ChecklistItem(
                ...
                keywords=[
                    "functional", "limitations", "participation", "impact on",
                    "activities of daily living", "ADL", "mobility",
                    "independence", "assistance required", "functional level"
                ],
                recommendation=(
            ...
            ChecklistItem(
                ...
                keywords=[
                    "plan of care", "continue", "modify", "change plan",
                    "treatment plan", "intervention", "approach",
                    "discharge planning", "POC"
                ],
                recommendation=(
            ...
            ChecklistItem(
                ...
                keywords=[
                    "range of motion", "ROM", "flexibility", "joint mobility",
                    "passive ROM", "active ROM", "PROM", "AROM", "degrees"
                ],
                recommendation=(
            ...
            ChecklistItem(
                ...
                keywords=[
                    "strength", "muscle strength", "MMT", "manual muscle test",
                    "weakness", "strong", "fair", "good", "trace"
                ],
                recommendation=(
            ...
            ChecklistItem(
                ...
                keywords=[
                    "intelligibility", "speech clarity", "articulation",
                    "pronunciation", "understandable", "clear speech",
            ...
            ChecklistItem(
                ...
                keywords=[
                    "swallowing", "dysphagia", "aspiration", "safe swallow",
                    "diet texture", "thickened liquids", "NPO", "PO intake"
                ],
                recommendation=(
