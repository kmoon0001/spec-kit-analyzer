...
class HabitProgressionService:
    ...
    def _calculate_progression_metrics(
        ...
        mastery_achievements = [
            (hid, data) for hid, data in habit_metrics["habit_breakdown"].items()
    ...
    def _calculate_weekly_trends(
        ...
        for week_offset in range(min(12, days_back // 7)):  # Max 12 weeks
            ...
            weeks.append({
                ...
                "avg_confidence": sum(f["confidence"] for f in week_findings) / len(week_findings) if week_findings else 0
            })
    ...
    def _empty_progression_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_progress": {"percentage": 0, "status": "New", "score": 0, "max_score": 28},
            "achievements": [],
            "current_goals": [],
            "recommendations": []
        }
    ...
    async def update_goal_progress(
        ...
        logger.info(f"Updated goal {goal_id} progress to {progress}% for user {user_id}")
        return True