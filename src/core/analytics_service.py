...
class AnalyticsService:
    ...
    def __init__(self, enable_advanced_features: bool = True):
        ...
        logger.info(f"Analytics service initialized (advanced features: {enable_advanced_features})")

    def calculate_compliance_trends(self,
        ...
        try:
            ...
            logger.info(f"Calculated trends for {len(trends)} days")
            return trends

        except Exception as e:
            logger.error(f"Error calculating compliance trends: {e}")
            return []
    ...
    def identify_common_issues(self,
        ...
        try:
            ...
            logger.info(f"Identified {len(common_issues)} common compliance issues")
    ...
    def calculate_performance_metrics(self, reports_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not scores:
                return {'total_reports': total_reports, 'error': 'No valid scores found'}
                ...
                if older_scores and recent_scores:
                    ...
                    if recent_avg < older_avg - 5:  # Significant decline
                        insights.append(AnalyticsInsight(
                            ...
                            description=f"Compliance scores have declined by {older_avg - recent_avg:.1f} points over the past week.",
                            impact_level="High",
                        ...
                        insights.append(AnalyticsInsight(
                            ...
                            description=f"Compliance scores have improved by {recent_avg - older_avg:.1f} points over the past week.",
                            impact_level="Low",
