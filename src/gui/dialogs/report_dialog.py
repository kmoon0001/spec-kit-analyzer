...
from PyQt6.QtWidgets import (
    QDialog, QVBoxLayout, QTextEdit, QDialogButtonBox, QPushButton, QFileDialog, QMessageBox
)
...
class ReportDialog(QDialog):
    ...
    def handle_anchor_click(self, url: QUrl):
        ...
        if url.scheme() == 'chat':
            ...
            chat_dialog = ChatDialog(initial_context=initial_context, chat_service=self.chat_service, parent=self)
            chat_dialog.exec()
        else:
