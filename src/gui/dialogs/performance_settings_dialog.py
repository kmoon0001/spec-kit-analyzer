...
class PerformanceSettingsDialog(QDialog):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        try:
            from ...core.performance_manager import PerformanceProfile, performance_manager

            self.performance_manager = performance_manager
            self.PerformanceProfile = PerformanceProfile
        except ImportError:
            logger.exception("Performance manager not available")
    ...
    def update_monitoring(self):
        ...
        try:
            ...
            try:
                ...
                self.cache_usage_label.setText(f"{cache_mb} MB")
            except ImportError:
                pass
    ...
    def get_performance_summary(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "current_profile": (
                    self.performance_manager.current_profile.value if self.performance_manager else "Unknown"
                ),
    ...
    def start_system_monitoring(self):
        ...
        try:
            ...
            logger.exception("Error starting system monitoring: %s", e)
