...
import { fetchAdvancedAnalytics, fetchPredictiveAnalytics, fetchBenchmarkData } from '../api';
...
export const useAdvancedAnalytics = (timeRange: string = 'Last 30 Days') => {
  ...
  return {
    ...
    isLoading: analyticsQuery.isLoading || predictiveQuery.isLoading || benchmarkQuery.isLoading,
    isError: analyticsQuery.isError || predictiveQuery.isError || benchmarkQuery.isError,
    refetch: () => {
