...
export const HabitsDistributionChart: React.FC<HabitsDistributionChartProps> = ({ habitsData }) => {
  ...
  const chartData = Object.entries(habitsData)
    ...
    .map(([, habit]) => ({
      ...
      fullName: habit.habit_name.length > 20 ? `${habit.habit_name.substring(0, 20)}...` : habit.habit_name,
    }));
