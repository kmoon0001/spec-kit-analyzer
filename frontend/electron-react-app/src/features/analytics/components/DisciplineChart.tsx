...
export const DisciplineChart: React.FC<DisciplineChartProps> = ({
  disciplineData,
}) => {
  const chartData = Object.entries(disciplineData).map(
    ([discipline, data]) => ({
    ...
    <div style={{ width: "100%", height: "300px" }}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis dataKey="discipline" stroke="#666" fontSize={12} />
          <YAxis yAxisId="left" stroke="#007acc" fontSize={12} />
          <YAxis
            yAxisId="right"
            orientation="right"
            stroke="#ffc107"
