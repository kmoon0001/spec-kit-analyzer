    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.metricsGrid}>
        ...
        <Card
          ...
          subtitle="Document distribution by therapy discipline"
        >
          <div className={styles.disciplineBreakdown}>
            <div className={styles.disciplineItem}>
              ...
              <div className={styles.disciplineBar}>
                <div
                  ...
                  style={{
                    width: `${analyticsData?.teamMetrics.disciplineBreakdown.pt || 0}%`,
                  }}
                />
              </div>
            ...
            <div className={styles.disciplineItem}>
              ...
              <div className={styles.disciplineBar}>
                <div
                  className={styles.disciplineFill}
                  style={{
                    width: `${analyticsData?.teamMetrics.disciplineBreakdown.ot || 0}%`,
                  }}
                />
              </div>
              <div className={styles.disciplineValue}>
            ...
            <div className={styles.disciplineItem}>
              <div className={styles.disciplineLabel}>
              ...
              <div className={styles.disciplineBar}>
                <div
                  className={styles.disciplineFill}
                  style={{
                    width: `${analyticsData?.teamMetrics.disciplineBreakdown.slp || 0}%`,
                  }}
                />
              </div>
              <div className={styles.disciplineValue}>
      ...
      <div className={styles.riskAnalysis}>
        <Card
          title="Risk Analysis"
          subtitle="Document risk distribution and trends"
        >
      ...
      <Card title="Compliance Trends" subtitle="Performance over time">
        <div className={styles.chartContainer}>
          <div className={styles.chartPlaceholder}>
            ...
            <p>
              Interactive chart showing compliance scores over the selected time
              period
            </p>
      ...
      <Card
        ...
        subtitle="Areas requiring team development"
      >
        <div className={styles.trainingNeeds}>
          ...
          <div className={styles.trainingItem}>
            ...
            <div className={styles.trainingContent}>
              ...
              <p>
                12% of documents require stronger medical necessity
                justification
              </p>
