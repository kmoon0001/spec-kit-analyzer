  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <p>
          Track your habit mastery, progress trends, and achievements in the 7
          Habits framework
        </p>
        <Button
          onClick={refetch}
      ...
      <div className={styles.summaryCard}>
        ...
        <div className={styles.improvementSection}>
          <div
            ...
            style={{
              color: getImprovementColor(progression?.improvement_rate || 0),
            }}
          >
            {getImprovementIcon(progression?.improvement_rate || 0)}{" "}
            {getImprovementText(progression?.improvement_rate || 0)}
          </div>
        </div>
      </div>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.rightPanel}>
          ...
          {/* Current Goals */}
          {progression?.current_goals &&
            progression.current_goals.length > 0 && (
          ...
          <Card title="🌟 This Week's Focus" className={styles.weeklyFocusCard}>
            <div className={styles.weeklyFocus}>
              <div className={styles.focusHabit}>
