...
def main():
    ...
    tests_total += 1
    if test_component(
        "Performance Monitor", lambda: __import__("src.core.performance_monitor", fromlist=["performance_monitor"])
    ):
        tests_passed += 1
    ...
    if test_component(
        ...
        lambda: __import__("src.core.enhanced_error_handler", fromlist=["enhanced_error_handler"]),
    ):
        tests_passed += 1
    ...
    if test_component(
        ...
        lambda: __import__("src.core.multi_agent_orchestrator", fromlist=["multi_agent_orchestrator"]),
    ):
        tests_passed += 1

    tests_total += 1
    if test_component(
        "ML Trend Predictor", lambda: __import__("src.core.ml_trend_predictor", fromlist=["ml_trend_predictor"])
    ):
        tests_passed += 1

    tests_total += 1
    if test_component(
        "Workflow Automation", lambda: __import__("src.core.workflow_automation", fromlist=["workflow_automation"])
    ):
        tests_passed += 1
    ...
    tests_total += 1
    if test_component(
        "EHR Integration API", lambda: __import__("src.api.routers.ehr_integration", fromlist=["router"])
    ):
        tests_passed += 1
    ...
    tests_total += 1
    if test_component(
        "System Validator", lambda: __import__("src.core.system_validator", fromlist=["system_validator"])
    ):
        tests_passed += 1
    ...
    tests_total += 1
    if test_component(
        "Analysis Service", lambda: __import__("src.core.analysis_service", fromlist=["DocumentAnalysisService"])
    ):
        tests_passed += 1
