...
from src.core.pdf_export_service import PDFExportError, PDFExportService
...
class TestPDFExportService:
    ...
    async def test_prepare_pdf_data(self, pdf_service, sample_report_data):
        ...
        pdf_data = await pdf_service._prepare_pdf_data(
            sample_report_data, include_charts=True, watermark="CONFIDENTIAL"
        )
    ...
    async def test_convert_charts_for_pdf(self, pdf_service):
        ...
        charts = [{"title": "Test Chart", "data": [1, 2, 3]}, {"title": "Another Chart", "data": [4, 5, 6]}]
    ...
    def test_optimize_content_for_print(self, pdf_service, sample_report_data):
        ...
        sample_report_data["findings"] = [{"rule_id": f"TEST_{i:03d}", "risk_level": "medium"} for i in range(15)]
    ...
    def test_calculate_combined_metrics(self, pdf_service, sample_report_data):
        ...
        reports = [{**sample_report_data, "compliance_score": 85.0}, {**sample_report_data, "compliance_score": 90.0}]
