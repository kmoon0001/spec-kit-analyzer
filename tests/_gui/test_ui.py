...
def mock_backend_services():
    with patch('src.gui.main_window.AILoaderWorker') as mock_ai_loader, \
         ...
         patch('src.gui.main_window.AnalysisWorker') as mock_analysis_worker, \
...
def test_run_analysis_button_triggers_worker(main_app_window: MainApplicationWindow, qtbot):
    """
