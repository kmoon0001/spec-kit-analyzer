...
class TestRuleBasedMapping:
    ...
    def test_habit_3_put_first_things_first_mapping(self):
        ...
        finding = {"issue_title": "Missing signature", "text": "Note not signed timely"}
    ...
    def test_default_to_habit_1_no_matches(self):
        ...
        finding = {"issue_title": "Random issue", "text": "No matching keywords"}
    ...
    def test_confidence_scoring(self):
        ...
        finding_weak = {"issue_title": "Random issue", "text": "No keywords"}
...
class TestEdgeCases:
    ...
    def test_finding_with_none_values(self):
        ...
        finding = {"issue_title": None, "text": None}
