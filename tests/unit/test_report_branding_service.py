...
class TestBrandingConfiguration:
    ...
    def test_branding_serialization(self):
        ...
        config = BrandingConfiguration(organization_name="Test Org", primary_color="#123456", secondary_color="#789abc")
...
class TestLogoProcessor:
    ...
    def test_process_raster_logo(self, mock_image, processor, temp_dir):
        ...
        config = LogoConfiguration(enabled=True, file_path=str(test_file), size=LogoSize.MEDIUM, opacity=0.8)
    ...
    def test_process_svg_logo(self, processor, temp_dir):
        ...
        config = LogoConfiguration(enabled=True, file_path=str(test_file), opacity=0.9)
...
class TestReportBrandingService:
    ...
    def test_configure_logo_success(self, branding_service, temp_logo_dir):
        ...
        success = branding_service.configure_logo(str(logo_file), position=LogoPosition.TOP_LEFT, size=LogoSize.LARGE)
    ...
    def test_get_logo_data_enabled(self, mock_process, branding_service, temp_logo_dir):
        ...
        mock_process.return_value = {"format": "png", "data": "data:image/png;base64,test", "width": 200, "height": 100}
    ...
    def test_generate_report_css_with_logo(self, mock_get_logo, branding_service):
        ...
        # Mock logo data
        mock_get_logo.return_value = {"format": "png", "data": "data:image/png;base64,test"}
    ...
    def test_get_branding_context_with_logo(self, mock_get_logo, branding_service, temp_logo_dir):
        ...
        # Mock logo data
        mock_logo_data = {"format": "png", "data": "data:image/png;base64,test"}
    ...
    def test_configuration_persistence(self, temp_config_dir):
        ...
        service1.update_branding(organization_name="Persistent Org", primary_color="#123456")
    ...
    def test_reset_to_defaults(self, branding_service):
        ...
        branding_service.update_branding(organization_name="Test Org", primary_color="#ff0000")
