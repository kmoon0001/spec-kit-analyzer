...
from src.core.compliance_types import TherapyDocument, ComplianceRule
...
class TestComplianceService(unittest.TestCase):
    ...
    def test_no_finding_when_required_keyword_present(self):
        ...
        doc = TherapyDocument(
            id="1",
            text="The document is signed by the therapist.",
            discipline="pt",
            document_type="Evaluation",
        )
        result = self.service.evaluate_document(doc)
    ...
    def test_finding_for_positive_and_negative_keywords(self):
        ...
        doc = TherapyDocument(
            id="1",
            text="The patient's goal is to improve walking. Signed by therapist.",
            discipline="pt",
            document_type="Progress Note",
        )
        result = self.service.evaluate_document(doc)
    ...
    def test_no_finding_when_negative_keyword_is_present_for_positive_rule(self):
        ...
        doc = TherapyDocument(
            id="1",
            text="The patient's goal is to improve walking. This is a measurable goal. Signed by therapist.",
            discipline="pt",
            document_type="Progress Note",
        )
        result = self.service.evaluate_document(doc)
    ...
    def test_document_type_mismatch(self):
        ...
        doc = TherapyDocument(
            id="1",
            text="The patient's goal is to improve walking.",
            discipline="pt",
            document_type="Evaluation",
        )
        result = self.service.evaluate_document(doc)
