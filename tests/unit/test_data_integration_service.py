...
class TestDataQuery:
    ...
    def test_query_to_dict(self):
        ...
        time_range = TimeRange.last_hours(24)
        query = DataQuery(
            source_types=[DataSourceType.PERFORMANCE_METRICS], time_range=time_range, filters={"test": "value"}
        )
...
class TestDataResult:
    ...
    def test_result_creation(self):
        ...
        result = DataResult(
            data={"test": "data"}, metadata=metadata, query=query, retrieved_at=datetime.now(), record_count=1
        )
    ...
    def test_result_to_dict(self):
        ...
        result = DataResult(data={"test": "data"}, metadata=metadata, query=query, retrieved_at=datetime.now())
...
class TestPerformanceDataProvider:
    ...
    async def test_get_data(self, provider):
        ...
        config = ReportConfig(
            report_type=ReportType.PERFORMANCE_ANALYSIS, title="Test Report", time_range=TimeRange.last_hours(24)
        )
    ...
    async def test_query_data(self, provider):
        ...
        query = DataQuery(source_types=[DataSourceType.PERFORMANCE_METRICS], time_range=TimeRange.last_hours(1))
...
class TestDataIntegrationService:
    ...
    def test_register_provider(self, service):
        ...
        mock_provider.get_metadata = AsyncMock(
            return_value=DataSourceMetadata(
    ...
    async def test_query_data(self, service):
        ...
        query = DataQuery(source_types=[DataSourceType.PERFORMANCE_METRICS, DataSourceType.SYSTEM_MONITORING])
