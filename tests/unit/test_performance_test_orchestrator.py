    ...
    def test_load_configurations_from_yaml(self):
        ...
        config_data = {
            "tests": [
                ...
                {"name": "test2", "category": "optimization", "description": "Test 2", "enabled": False},
            ],
            "suites": {"custom_suite": ["test1", "test2"]},
        }
...
class TestExecutionEngine:
    ...
    async def test_execute_test_success(self):
        ...
        config = PerformanceTestConfig(
            name="test_success", category=PerformanceCategory.BASELINE, description="Successful test"
        )
    ...
    async def test_execute_test_failure(self):
        ...
        config = PerformanceTestConfig(
            name="test_failure", category=PerformanceCategory.BASELINE, description="Failing test"
        )
    ...
    async def test_execute_test_no_runner(self):
        ...
        config = PerformanceTestConfig(
            name="test_no_runner", category=PerformanceCategory.BASELINE, description="Test with no runner"
        )
...
class TestPerformanceTestOrchestrator:
    ...
    def test_generate_recommendations(self):
        ...
        test_results_with_failures = [
            ...
            SingleTestResult(
                "test2",
                PerformanceCategory.OPTIMIZATION,
