...
class TestCachePerformanceMonitor:
    ...
    def test_performance_summary(self):
        ...
        for i in range(10):
            ...
            duration = 50.0 + i * 10  # Increasing duration
...
class TestPerformanceOptimizer:
    ...
    async def test_optimize_performance(self):
        ...
        with patch.object(optimizer, 'analyze_performance', return_value=mock_metrics):
            with patch.object(optimizer.advanced_cache, 'optimize_cache_performance', 
                            new_callable=AsyncMock, return_value={'status': 'completed'}):
                with patch.object(optimizer, '_optimize_memory_usage', 
                                new_callable=AsyncMock, return_value={'memory_freed_mb': 50.0}):
    ...
    def test_generate_optimization_recommendations(self):
        ...
        cache_stats = {
            'performance_metrics': {
                'optimization_recommendations': ['Base recommendation']
            }
        }
    ...
    def test_calculate_performance_improvements(self):
        ...
        assert improvements['hit_rate_improvement_percent'] == pytest.approx(20.0)
    ...
    async def test_proactive_warming(self):
        ...
        mock_warming_result = {
            'status': 'completed',
            'total_items_warmed': 15,
            'duration_ms': 1500.0
        }
        
        with patch.object(optimizer.advanced_cache.cache_warming, 'execute_warming', 
                         new_callable=AsyncMock, return_value=mock_warming_result):
