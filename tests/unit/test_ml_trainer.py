...
def ml_pipeline(temp_models_dir, mock_calibration_trainer):
    ...
    return MLTrainingPipeline(calibration_trainer=mock_calibration_trainer, models_dir=temp_models_dir)
...
class TestMLTrainingPipeline:
    ...
    def test_should_retrain_time_based(self, ml_pipeline):
        ...
        recent_training = {"last_training": datetime.now().isoformat(), "training_count": 1}
        ...
        old_training = {"last_training": (datetime.now() - timedelta(days=10)).isoformat(), "training_count": 1}
    ...
    def test_get_next_training_time(self, ml_pipeline):
        ...
        metadata = {"last_training": last_training.isoformat(), "training_count": 1}
    ...
    def test_update_training_metadata(self, ml_pipeline):
        ...
        evaluation_results = {"ece_improvement": 0.15, "brier_improvement": 0.05, "method_used": "temperature"}
...
class TestMLTrainingIntegration:
    ...
    async def test_end_to_end_training_pipeline(self, temp_models_dir):
        ...
        pipeline = MLTrainingPipeline(calibration_trainer=trainer, models_dir=temp_models_dir)
