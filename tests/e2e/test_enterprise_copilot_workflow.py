...
class TestEnterpriseCopilotWorkflow:
    ...
    @pytest.mark.asyncio
    async def test_basic_copilot_query_workflow(
        self,
    ...
    @pytest.mark.asyncio
    async def test_copilot_capabilities_discovery(
        self,
        e2e_helper: E2ETestHelper
    ):
        ...
        response = e2e_helper.client.get(
            "/enterprise-copilot/capabilities",
            headers=e2e_helper.headers
        )
    ...
    @pytest.mark.asyncio
    async def test_workflow_automation_creation(
        self,
        e2e_helper: E2ETestHelper
    ):
        ...
        response = e2e_helper.client.post(
            "/enterprise-copilot/workflow/automate",
    ...
    @pytest.mark.asyncio
    async def test_copilot_help_system(
        self,
        e2e_helper: E2ETestHelper
    ):
        ...
        response = e2e_helper.client.get(
            "/enterprise-copilot/help/topics",
            headers=e2e_helper.headers
        )
    ...
    @pytest.mark.asyncio
    async def test_copilot_status_monitoring(
        self,
        e2e_helper: E2ETestHelper
    ):
    ...
    @pytest.mark.asyncio
    async def test_discipline_specific_queries(
        self,
        e2e_helper: E2ETestHelper
    ):
    ...
    @pytest.mark.asyncio
    async def test_copilot_performance_under_load(
        self,
        e2e_helper: E2ETestHelper,
        e2e_test_config: Dict[str, Any]
    ):
        ...
        print(f"✅ Load test passed: {successful_responses}/{len(queries)} successful, avg {avg_time_per_query:.2f}s per query")