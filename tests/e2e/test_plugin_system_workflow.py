...
class TestPluginSystemWorkflow:
    ...
    @pytest.mark.asyncio
    async def test_plugin_discovery_workflow(
        self,
        ...
        discovery_response = e2e_helper.client.post(
            "/plugins/discover",
        ...
        list_response = e2e_helper.client.get(
            "/plugins/",
            headers=e2e_helper.headers
        )
        ...
        for plugin in plugins_list["plugins"]:
            ...
            detail_response = e2e_helper.client.get(
                f"/plugins/{plugin_name}/status",
                headers=e2e_helper.headers
            )
    ...
    @pytest.mark.asyncio
    async def test_plugin_lifecycle_management(
        self,
        e2e_helper: E2ETestHelper
    ):
        ...
        status_response = e2e_helper.client.get(
            f"/plugins/{plugin_name}/status",
            headers=e2e_helper.headers
        )
        ...
        if initial_status["status"] != "loaded":
            load_response = e2e_helper.client.post(
                f"/plugins/{plugin_name}/load",
                headers=e2e_helper.headers
            )
        ...
        unload_response = e2e_helper.client.post(
            f"/plugins/{plugin_name}/unload",
            headers=e2e_helper.headers
        )
        ...
        final_status_response = e2e_helper.client.get(
            f"/plugins/{plugin_name}/status",
            headers=e2e_helper.headers
        )
    ...
    @pytest.mark.asyncio
    async def test_plugin_extension_points(
        self,
        e2e_helper: E2ETestHelper
    ):
        ...
        extension_response = e2e_helper.client.get(
    ...
    @pytest.mark.asyncio
    async def test_plugin_batch_operations(
        self,
        e2e_helper: E2ETestHelper
    ):
        ...
        batch_response = e2e_helper.client.post(
            "/plugins/batch/load",
            json={"operation": "load_all_available"},
            headers=e2e_helper.headers
        )
        ...
        while time.time() - start_time < max_wait_time:
            status_response = e2e_helper.client.get(
                f"/plugins/batch/status/{task_id}",
                headers=e2e_helper.headers
            )
