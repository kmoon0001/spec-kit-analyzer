...
from src.gui.core import ResourceMonitor, ResourceMetrics, BaseWorker, ResourceManager, JobPriority, WorkerSignals
...
class TestBaseWorker:
    ...
    def test_error_handling(self, qapp, thread_pool):
        ...
        assert error_received[0][0] is ValueError
...
class TestResourceManager:
    ...
    def test_initialization(self, qapp, thread_pool, resource_monitor):
        ...
        manager = ResourceManager(thread_pool=thread_pool, resource_monitor=resource_monitor)
    ...
    def test_queue_full_handling(self, qapp, thread_pool, resource_monitor):
        ...
        manager = ResourceManager(thread_pool=thread_pool, resource_monitor=resource_monitor, max_queue_size=2)
